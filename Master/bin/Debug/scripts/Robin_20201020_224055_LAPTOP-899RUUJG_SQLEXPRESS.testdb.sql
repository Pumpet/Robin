-- 20.10.2020 22:40:55 LAPTOP-899RUUJG\SQLEXPRESS.testdb 
-- Script for 'Robin'
...
insert dm.tMenu (code, appcode, parentId, ord, caption, img, execType, command, marker) 
    values ('ddDocs', 'Robin', null, 1, 'Документы', 'down', 1, null, null)
insert dm.tMenu (code, appcode, parentId, ord, caption, img, execType, command, marker) 
    values ('ddDoc', 'Robin', null, 1, 'Тест', '', 1, null, null)
insert dm.tMenu (code, appcode, parentId, ord, caption, img, execType, command, marker) 
    values ('miSimple', 'Robin', null, 1, 'Simple Form', '', 0, '', null)
insert dm.tMenu (code, appcode, parentId, ord, caption, img, execType, command, marker) 
    values ('ddTest1', 'Robin', 3, 1, 'Тест 1', '', 1, null, null)
insert dm.tMenu (code, appcode, parentId, ord, caption, img, execType, command, marker) 
    values ('miTest11', 'Robin', 7, 1, 'Тест метод', '', 0, 'TestMethod', null)
insert dm.tMenu (code, appcode, parentId, ord, caption, img, execType, command, marker) 
    values ('miDocList1', 'Robin', 2, 1, 'Документы-1', '', 0, 'DocList1', null)
